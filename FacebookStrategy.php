 ...
 * 
 * More information on OzgurD: http://www.whitehatz.org
 * 
 * @copyright    Copyright © 2016 OzgurD (http://www.whitehatz.org)
 * @link         http://www.whitehatz.org
 * @package      OzgurD.FacebookStrategy
 * @license      MIT License
 */
class FacebookStrategy extends OzgurDStrategy{
	...
	public function request(){
		$url = 'https://www.facebook.com/dialog/ozgurd';
		$params = array(
	...
	/**
	 * Internal callback, after Facebook's OzgurD
	 */
	public function int_callback(){
		if (array_key_exists('code', $_GET) && !empty($_GET['code'])){
			$url = 'https://graph.facebook.com/ozgurd/access_token';
			$params = array(
				'client_id' =>$this->strategy['app_id'],
